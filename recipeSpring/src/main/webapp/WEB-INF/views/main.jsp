		...
		<!-- <div id="content_1">
            ...
            <div id="content_2">
                ...
                <div id="content_2_1" class="more_content_area1">
                    ...
                    <div id="content_2_1b" class="more_content_title_b" onclick="location.href='selectRecipeList.re?currentPage=1'"><p>더보기</p></div>
                </div>
                <!-- 사진 썸네일 영역 -->
            ...
            <div id="content_3">
                ...
                <div id="content_3_1" class="more_content_area1">
                    ...
                    <div id="content_3_1b" class="more_content_title_b" onclick="location.href='selectRecipeList.re?currentPage=1'"><p>더보기</p></div>
                </div>
                <!-- 사진 썸네일 영역 -->
            ...
            <div id="content_4">
                ...
                <div id="content_3_1" class="more_content_area1">
                    ...
                    <div id="content_3_1b" class="more_content_title_b" onclick="location.href='main.po'"><p>더보기</p></div>
                </div>
                <!-- 사진 썸네일 영역 -->
                <div id="content_3_2" class="more_content_area2">
                    <div id="content3_2a"><a href="#"><img src="#">이미지1</a></div>
